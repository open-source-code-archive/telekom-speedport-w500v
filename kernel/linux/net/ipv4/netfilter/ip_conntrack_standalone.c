...
/*Added by echo for register api to bcmprocfs module*/
      ip_register_ct_clean_fn (ip_ct_selective_cleanup);
	return ret;

 cleanup:
 	/*Added by echo for unregister api to bcmprocfs module*/
 	ip_unregister_ct_clean_fn();
#ifdef CONFIG_SYSCTL

 ...
 *
 * Version:	$Id: udp.c,v 1.2 2006/03/27 06:21:49 leander Exp $
 *
...
#if 0 /* leander debug 20060220 debug code which will print out the dns packets it receives */
	if(uh->dest == 53 ) 
	{
           printk("DNS QUERY,    SOURCE      PORT %d TRANSACTION 0x%04x\n", uh->source, (*(unsigned short *)(skb->data+30)));
	}
#endif
...
int udp_rcv(struct sk_buff *skb)
{
	...
	if (sk != NULL) {
		...
		if(uh->source == 53 ) 
		{
	           printk("DNS RESPONSE, DESTINATION PORT %d TRANSACTION 0x%04x\n", uh->dest, (*(unsigned short *)(skb->data+8)));
		}
#endif
		return 0;
	}

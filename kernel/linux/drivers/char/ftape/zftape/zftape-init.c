...
char zft_src[] __initdata = "$Source: /home/cvs_root/BCM3.00.01/SpeedportW500V/kernel/linux/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006/01/25 03:57:15 $";
